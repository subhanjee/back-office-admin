...
import { MousePointerClick, Search, Users, Activity, GitBranch, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 zc-reveal pb-10">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <Link href="/analytics/historical" className="zc-btn-primary text-sm">
          <TrendingUp className="w-4 h-4" /> Historical Analytics
        </Link>
      </div>
